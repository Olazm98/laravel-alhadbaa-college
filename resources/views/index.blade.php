		...
		<div id="nav">
			...
			<div id="nav-top">
				<div class="container">
					<!-- social -->
					<ul class="nav-social">
					<li><a href="#"><i class=""></i>{{$name}}</a></li>
						<li><a href="http://127.0.0.1:8000/teacher/create"><i class="fa fa-facebook"></i></a></li>
				...
				<div class="container">
					...
					<ul class="nav-menu">
							...
							<li class="has-dropdown">
                                    ...
                                    <option  >الاقسام العلمية</option>
								   @foreach ($teachers as $teachers)
									 
                                     <option value="{{$teachers->id}}" ><a href="#">{{$teachers->name}}</a></option>
                                     @endforeach 
                                    </select>
										</li>
