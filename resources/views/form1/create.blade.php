...
<button type="button" class="btn btn-success">  <a class="dropdown-item" href="{{route('form1s')}}">العودة الى لوحة التحكم الاقسام    <i class="fas fa-fw fa-plus-square"></i></button></a>
    <br><br>
@endsection
@section('styles')
