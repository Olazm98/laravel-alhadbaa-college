...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{route('pref.store')}}" method="POST" enctype="multipart/form-data" >
                        {{ csrf_field()}}
		...
		<button type="button" class="btn btn-success">  <a class="dropdown-item" href="{{route('prefs')}}">العودة الى لوحة التحكم الهيئة التدريسيه  <i class="fas fa-fw fa-plus-square"></i></button></a>
    <br><br><br><br>
    </div>
</div>
@endsection
